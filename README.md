...
Rscript scripts/make_sa_fig5genes.R  # Fig. 5
Rscript scripts/make_sa_fig3.R        # Fig. 6
Rscript scripts/make_sa_fighall.R     # Fig. 7
Rscript scripts/make_sa_figgtex.R     # Fig. 8, Supplementary Fig. S8, Supplementary Table 9
