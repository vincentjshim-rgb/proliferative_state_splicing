...
| `public_data_tierA/derived/figures_sciadv/` | The rendered figures (Fig. 1–6, Supplementary Fig. S1–S10), 600 dpi PNG. |
...
Rscript scripts/make_sa_fig3merged.R  # Fig. 3
Rscript scripts/make_sa_fig3.R        # Fig. 4
Rscript scripts/make_sa_fighall.R     # Fig. 5
Rscript scripts/make_sa_figgtex.R     # Fig. 6, Supplementary Fig. S10, Supplementary Table 9
...
Twenty-six superseded scripts write to filenames the current figures use. Each begins with a
