...
**Availability.** All datasets are public and listed with accessions in Supplementary Table 4. Analysis code, gene lists, contrast definitions, both preregistration documents with their locked SHA-256 digests, and the twelve Supplementary Data tables are public at https://github.com/vincentjshim-rgb/proliferative_state_splicing. We will archive the accepted release with a Zenodo DOI.
