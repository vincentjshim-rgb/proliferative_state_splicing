...
| Supplementary Data 12 | `SupplementaryData12_junction_psi_vs_proliferation.tsv` | Every testable splicing event of the donor cohort with its inclusion level and its association with the proliferation score and with donor age, before and after adjustment (Fig. 3a, e) |
...
| Supplementary Data 14 | `SupplementaryData14_classified_splicing_events.tsv` | Every event of Supplementary Data 12 classified against GENCODE v41: event type, the alternative exon or segment with its transcript-type annotation, the junction measured, its share in the slowest and fastest thirds of donors, and the tests against proliferation and age (Fig. 3b–d) |
""")
