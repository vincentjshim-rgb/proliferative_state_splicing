...
- **S1** Compare the partial ρ with proliferation of the 24 programmes side by side in culture, the two skin sites and skeletal muscle (the tissue version of Fig. 8A). [Translator's note: "Fig. 8A" is the panel number in the draft current at the time of writing; it is Fig. 6a in the revised manuscript.]
